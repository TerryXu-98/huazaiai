# 花再 AI / HUAZAIDESIGN · skill.md

> 当前项目能力 / 接口 / 文件用途速查手册。
> 当前版本：v2.0.0 ｜ 仓库：<https://github.com/liang2045/huazaiai>
>
> 下方原有 T8-penguin-canvas 大量内容为“上游项目与历史改造技术记录”，仅用于兼容、排错和后续开发参考。T8PC、T8ENC1 等名称可能是历史环境变量、加密格式或打包链路名，不做全局替换。
>
> ## 当前项目状态
>
> - 当前版本：v2.0.0
> - 当前品牌：HUAZAIDESIGN / 花再 AI（Huazai AI）
> - 技术栈：React 19 + TypeScript + Vite + Express + Electron
> - 前端端口：11422
> - 后端端口：18766
> - Windows 安装包：HuazaiAI-Setup-2.0.0.exe
>
...
以下内容保留为上游项目与历史改造技术记录，仅用于兼容、排错和后续开发参考；其中“仅运行于浏览器”“严格剔除桌面端封装”等描述是上游历史定位，不代表当前花再 AI / HUAZAIDESIGN 的项目状态。当前项目状态以上方“当前项目状态”为准。
