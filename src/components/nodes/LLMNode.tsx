...
const LLMNode = ({ id, data, selected }: NodeProps) => {
  ...
  return (
    <div className="huazai-llm-node relative flex items-start gap-0" style={llmThemeVars} {...dropProps}>
      {/* 输入 Handle — 固定在整体左侧 */}
      <Handle
        type="target"
    ...
    <div
      ref={mainRef}
      className={`huazai-llm-main relative rounded-xl border-2 transition-all w-[320px] ${
    ...
    {hasChat && (
      <div
        ref={chatRef}
          className={`huazai-llm-chat llm-chat-panel w-[260px] rounded-xl border-2 pl-2.5 pt-2.5 pb-2.5 pr-0 ${
