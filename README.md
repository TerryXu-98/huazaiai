...
> 花再 AI（Huazai AI）· AI 节点画布工作流工具 · Web + Electron 桌面端｜v3.1.8
>
> 当前界面品牌：HUAZAIDESIGN；当前安装包：`HuazaiAI-Setup-3.1.8.exe`。
...
![status](https://img.shields.io/badge/version-v3.1.8-brightgreen) ![node](https://img.shields.io/badge/node-%E2%89%A518-blue) ![react](https://img.shields.io/badge/react-19-61dafb) ![electron](https://img.shields.io/badge/electron-33-47848f) ![license](https://img.shields.io/badge/license-MIT-yellow)
...
产物：`dist_electron/HuazaiAI-Setup-3.1.8.exe`
